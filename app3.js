...
const apiKey= 'a9b14e5a61eec382085f19186e200bcb'; 


//Button Event listener 'click' 
button.addEventListener('click', function(){
    window.city.innerHTML="LOADING..."
    window.weather.innerHTML= ""
    window.feels.innerHTML=""
    window.currentTemp.innerHTML=""
    window.minTemp.innerHTML=""
    window.maxTemp.innerHTML=""
